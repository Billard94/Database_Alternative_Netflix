...
<head>
  ...
  session_start();
    ...
    */
    ...
    $query = "SELECT m.movie_id,m.name, EXTRACT(year FROM m.date_released), m.picture_url, AVG(w.rating) as av
    FROM project.movie m, project.watches w
    WHERE m.movie_id = w.movie_id AND w.rating IS NOT NULL
  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container">
        <h1 class="page-header">Best Rated Movies</h1>
        <p class="lead">Here is the best rated movies!</p>
      ...
      <div class="col-md-3">
        <div class="thumbnail card">
          ...
          <div class="caption">
            ...
            <p class=""><b>Rating:</b> <?php echo $row[0]; ?>
